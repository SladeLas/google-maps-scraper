"""Models and scrapes detailed LinkedIn Job postings via Selenium."""
...
class Job(Scraper):
    ...
    def __init__(
        ...
        """Create a job wrapper; optionally trigger scraping immediately."""
    ...
    def scrape(self, close_on_complete=True):
        """Scrape the job page based on the current authentication context."""
    ...
    def scrape_logged_in(self, close_on_complete=True):
        """Collect detailed job information while authenticated."""
