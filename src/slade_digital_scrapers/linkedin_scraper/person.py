"""High-level scraper for LinkedIn profile pages."""
...
class Person(Scraper):
    """Represents a LinkedIn profile and provides scraping utilities."""
    ...
    def __init__(
        ...
        """Instantiate and optionally start scraping a LinkedIn profile."""
    ...
    def scrape(self, close_on_complete=True):
        """Scrape the profile depending on login status."""
    ...
    def is_open_to_work(self):
        """Return True if the user has the '#OPEN_TO_WORK' badge."""
    ...
    def get_experiences(self):
        """Scrape the experience section and normalise its entries."""
    ...
    def get_name_and_location(self):
        """Populate the cached name and location fields."""
    ...
    def get_about(self):
        """Capture the 'About' section text when available."""
    ...
    def scrape_logged_in(self, close_on_complete=True):
        """Full scraping workflow for authenticated sessions."""
